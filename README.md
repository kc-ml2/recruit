...
## KC Machine Learning Lab (ML2) 소개
  ...
  * ML2의 현재 연구 주제는 KC가 기술의 수요자 측면에서 활용 가능성이 있는 주제와 기술의 공급자 측면에서 반도체 산업에 적용 가능성이 있는 주제를 모두 포함합니다.
  * ML2의 목표는 연구 결과의 사업화에 있지 않고, 지속적인 학술 연구를 통해 여러 연구 기관들과 협업 체계를 갖추고 내부 역량을 축적하는 것에 있습니다. 추후에 사업에 적용이 가능한 연구 결과가 도출 되면, 이러한 ML2의 기반을 바탕으로 사업화를 위한 별도의 팀을 구성할 예정입니다.

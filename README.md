...
## KC Machine Learning Lab (ML2) 소개
  ...
  * 2018년부터 현재까지 ML2는        
      ...
      * 머신러닝에 관심을 가지는 [대학동아리](https://blog.diyaml.com/introduction/)를 지원하며,
      * KC와 관계사들이 반도체 및 디스플레이 분야에서 첨단 기술 제조업 솔루션에 머신러닝을 적용하는데 도움을 주고 있습니다.
  * ML2는
    * 중기적(5년~)으로는
      * 다양한 연구개발 활동을 통하여 머신러닝의 첨단 기술을 내재화하고, 
  ...
  * ML2의 목표는 지속적인 학술 연구를 통해 여러 연구 기관들과 협업 체계를 갖추고 내부 역량을 축적하는 것에 있습니다. 
    * ML2의 연구 결과 중 추후 사업에 적용이 가능한 결과가 도출 되면 사업화를 위한 별도의 팀을 구성합니다.
  * ML2는 머신러닝 인큐베이션 프로그램([MLIP](https://www.kc-ml2.com/mlip))을 운영합니다.
    * 사업화를 위해 구성된 팀은 MLIP를 통해 독자적인 사업을 진행합니다.
    * 도전적인 목표를 추구하는 ML2의 멤버가 이러한 팀을 구성하는 것도 가능하며 장려됩니다.
